    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          Hello! My name is Abhishek Chawla. I am an independent Java Backend developer. I like many different directions related to the development of digital products.
            <br/>
            <br/>
